...
public class UIFrame extends BaseActivity {
	...
	private BroadcastReceiver mTabChangeReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			int intExtra = intent.getIntExtra(A.string.EXTRA_TAB_INDEX, R.id.rb_frame_item_one);
			mRgNavigator.check(intExtra);
		}
	};
	...
	@OnCheckedChanged(
			{
					R.id.rb_frame_item_one,
					R.id.rb_frame_item_two,
					R.id.rb_frame_item_three,
